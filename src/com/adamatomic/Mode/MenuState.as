package com.adamatomic.Mode
{
	...
	public class MenuState extends FlxState
	{
		...
		override public function MenuState():void
		{
			...
			{
				if(i%3)
					this.add(a.add(new FlxSprite(null,0,0,false,false,16,16,0xff3a5c39)) as FlxSprite);
				else
					this.add(a.add(new FlxSprite(null,0,0,false,false,2,2,0xffd8eba2)) as FlxSprite);
			}
