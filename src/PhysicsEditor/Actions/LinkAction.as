package PhysicsEditor.Actions
{
	...
	public class LinkAction extends ActionBase
	{
		...
		override public function onHandleEnd():void{
			var body1:b2Body = Utilities.GetBodyAtPoint(state.worldWrapper.the_world, args["start"], true);
			var body2:b2Body = Utilities.GetBodyAtPoint(state.worldWrapper.the_world, args["end"], true);
